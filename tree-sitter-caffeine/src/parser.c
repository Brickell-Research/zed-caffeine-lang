...
enum ts_symbol_identifiers {
  ...
  anon_sym_Requires = 7,
  anon_sym_Provides = 8,
  sym_extendable_name = 9,
  anon_sym_Blueprints = 10,
  anon_sym_for = 11,
  anon_sym_PLUS = 12,
  anon_sym_Expectations = 13,
  anon_sym_Expects = 14,
  anon_sym_STAR = 15,
  anon_sym_extends = 16,
  anon_sym_LBRACK = 17,
  ...
  anon_sym_Boolean = 25,
  anon_sym_URL = 26,
  anon_sym_Percentage = 27,
  anon_sym_List = 28,
  anon_sym_Dict = 29,
  anon_sym_Optional = 30,
  anon_sym_Defaulted = 31,
  anon_sym_x = 32,
  anon_sym_PIPE = 33,
  anon_sym_in = 34,
  anon_sym_DOT_DOT = 35,
